...
// import shortcutKeyRegister from './src/utils/shortcutKeyController'
...
// const goHortKeyApi = currentShortKeyApi.get('advance')!

// goHortKeyApi((e) => {
//   if (e.type === 'keydown' && carBody) {
//     console.log('go')
//     carBody.applyLocalForce(new Vec3(200, 0, 0), new Vec3(0, 0, 0))
//   }
// })

import './example/test01'
